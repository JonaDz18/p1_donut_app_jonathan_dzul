      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            // Total del carrito
            CartSummary(itemCount: cart.itemCount, totalAmount: cart.totalAmount), // Actualizamos el CartSummary
          ],
        ),
      ),
    );
...
class CartSummary extends StatelessWidget {
  ...
  const CartSummary({super.key, required this.itemCount, required this.totalAmount});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8), // Espacio entre el texto principal y el texto de entrega
