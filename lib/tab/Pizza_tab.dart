...
import 'package:p1_donut_app_jonathan_dzul/utils/pizza_tile.dart';
...
class PizzaTab extends StatelessWidget {
  ...
  PizzaTab({super.key, required this.onAddToCart}); // Asegúrate de recibir el callback
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return PizzaTile(
          ...
          onAddToCart: () => onAddToCart(double.parse(pizzasOnSale[index][1])), // Llama al callback
        );
      },
    );
  }
