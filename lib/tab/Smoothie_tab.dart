...
import 'package:p1_donut_app_jonathan_dzul/utils/smoothie_tile.dart';
...
class SmoothieTab extends StatelessWidget {
  ...
  SmoothieTab({super.key, required this.onAddToCart}); // Asegúrate de recibir el callback
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return SmoothieTile(
          ...
          onAddToCart: () => onAddToCart(double.parse(smoothiesOnSale[index][1])), // Llama al callback
        );
      },
    );
  }
