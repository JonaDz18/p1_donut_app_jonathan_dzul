...
import 'package:p1_donut_app_jonathan_dzul/utils/donut_tile.dart';
...
class DonutTab extends StatelessWidget {
  ...
  DonutTab({super.key, required this.onAddToCart}); // Asegúrate de recibir el callback
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return DonutTile(
          ...
          onAddToCart: () => onAddToCart(double.parse(donutsOnSale[index][1])), // Llama al callback
        );
      },
    );
  }
